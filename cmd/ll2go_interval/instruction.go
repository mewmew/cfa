...
// ipred converts the given LLVM IR integer predicate to a corresponding Go
// token.
...
// fpred converts the given LLVM IR floating-point predicate to a corresponding
// Go token.
func fpred(pred enum.FPred) token.Token {
